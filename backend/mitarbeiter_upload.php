			...
			<div class="content">
				<div class="text">
					...
					?>
						...
						<table class="tbl">
							<tr>
								<td class="small">Laborlieferdatum: </td><td><?=$lieferdatum;?></td>
								<input type="hidden" value="<?=$lieferdatum;?>" name="lieferdatum" />
							</tr>
							<tr>
								<td class="small">Laborrechnungsnummer: </td><td><?=$rechnungsnummer;?></td>
								<input type="hidden" value="<?=$rechnungsnummer;?>" name="rechnungsnummer" />
							</tr>
							<tr>
							<td class="small">Auftragsnummer: </td><td><?=$order_no;?></td>
						<input type="hidden" value="<?=$order_no;?>" name="auftragsnummer"/>
							</tr>
							<tr>
						<td class="small">Kunde: </td><td><?=$customer;?></td>
						<input type="hidden" value="<?=$kunden_id;?>" name="kunde" />
							</tr>
						</table>
						...
						<div class="topspace"></div>
						<button type="submit" class="form_btn submit">Eintragen in Datenbank</button>
						</form>
					</table>
				</div>
			</div>
